...
void CGameTimer::Tick(float fLockFPS){
	...
	if (fLockFPS > 0.0f) // 이 함수의 파라미터가 0 보다 크면 이 시간만큼 호출한 함수를 기다리게 한다.
	{
	...
	//초당 프레임 수를 1 증가시키고 현재 프레임 처리시간을 누적하여 저장한다.
	m_FramePerSecond++;
...
unsigned long CGameTimer::GetFrameRate(LPSTR lpszString, int nCharacters)
{
